...
SOPCINFO_FILE := E:/DEVELOPMENT/PROJECTS/KBD/Qsys/Hardware/TPK.sopcinfo
...
# The SOPC System ID 
# setting SOPC_SYSID is 493
SOPC_SYSID_FLAG += --id=493
ELF_PATCH_FLAG  += --id 493

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x10a8
SOPC_SYSID_FLAG += --sidp=0x10a8
ELF_PATCH_FLAG  += --sidp 0x10a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1623147102
SOPC_SYSID_FLAG += --timestamp=1623147102
ELF_PATCH_FLAG  += --timestamp 1623147102
...
# setting hal.stderr is led_con
ELF_PATCH_FLAG  += --stderr_dev led_con

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is led_con
ELF_PATCH_FLAG  += --stdin_dev led_con
...
# setting hal.stdout is led_con
ELF_PATCH_FLAG  += --stdout_dev led_con
