...
# setting hal.log_port is key_con
...
# setting hal.stderr is key_con
ELF_PATCH_FLAG  += --stderr_dev key_con

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is key_con
ELF_PATCH_FLAG  += --stdin_dev key_con
...
# setting hal.stdout is key_con
ELF_PATCH_FLAG  += --stdout_dev key_con
