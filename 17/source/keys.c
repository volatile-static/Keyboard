...
void scan_timeout_handler(void *p) {
    if (tca8418_getReg(REG_INT_STAT)) {
        tca8418_keyScan();
...
void reg_init(void) {
	tca8418_setReg(REG_CFG, CFG_GPI_IEN | CFG_INT_CFG); //https://e2echina.ti.com/support/interface/f/interface-forum/276651/tca8418/905128?tisearch=e2e-sitesearch&keymatch=tca8418%252520%2525E4%2525B8%2525AD%2525E6%252596%2525AD#905128
...
void tca8418_init(void) {
    ...
    FillTable();
    app_timer_create(&SCAN_TIM, APP_TIMER_MODE_REPEATED, scan_timeout_handler);
    app_timer_start(SCAN_TIM, APP_TIMER_TICKS(15), NULL);
}
